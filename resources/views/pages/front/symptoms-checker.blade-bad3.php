...
<div class="container-fluid" style="background-color: #DDD; padding: 0; height:  100vh ">
    <!-- Appointment Form Start  lg-->
      <div class="row hidden-xs" style="margin-top: 11em">
          
          <div class="col-md-5 nospace" class="imgBox">
          ...
          <style>
            ...
            .bg-image {
              /* The image used */
              background-image: url({{asset('assets/front/images/front/bg.jpg')}});
        ...
        <div class="col-md-7 nospace">
          <div style="height: 100vh; padding:0">
            <div class="bg-image"></div>
              <div class="bg-text" style="padding: 1em; margin-right: 4em;">
                  <div style="position: absolute; height: 100vh; width:100%;padding-right: 2em; overflow: scroll">
                      <form id="regForm" action="#/action_page.php" classx="md__contactForm">

                        <h3>  <span style="font-size: 60px; transform: rotate(0deg);" id="selectedPainAreaBox"> <i class="fa fa-hand-point-left"></i> Click where it hurts the most</span></h3>
                        <br>
