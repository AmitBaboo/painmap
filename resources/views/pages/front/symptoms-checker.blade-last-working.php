...
<body class="mainbg" style="font-family:CeraPro; height: 100vh; background-color: #e1f0f9">
    <!-- Header Start -->

    @include('pages.front.nav')

    <div class="container-fluid mainbg"
        style="background-color: #e1f0f9; padding: 0; max-width:100%; xheight: 100vh; margin-top: 1em ">
                    ...
                    <div
                        ...
                        <div id="ximgfront" style="background-color: #fff;  padding:0%;">
                            ...
                            <map name="map">
                                ...
                                <!--do 4 both and then back also &  then elbow, forearm, wrist /hand marked-->
                                <area onclick="setPainArea('Upper Arm',4)" target="" alt="bicep" title="Upper Arm"
                                ...
                                {{-- <area onclick="setPainArea('cervical spine',18)" target="" alt="cervical spine" title="Neck" href="#" coords="1019,679,80" shape="circle"> --}}
