...
<div class="content-wrapper">
              ...
              <tbody>
                 @foreach($categories as  $item)
                     <tr>
                        ...
                        <td>
                            <a onclick="page_editable_cat({{ $item->id }},'{{$item->name}}')" class="btn btn-info" data-toggle="modal" data-target="#modal-xl"><i class="fa fa-pen"></i></a>
      ...
      <div class="modal-content">
        ...
        <form id="edit_page_content" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body" id="page_editable_content">
            ...
            <div class="col-10">
                <input id="catname" type="text" class="form-control" name="name" placeholder="Cat  Name" required />
          ...
          <div class="modal-body" id="page_add_content">
            ...
            <div id="answers_div">
                ...
                <div class="ansrow1">
                  <div class="row">
                    <div class="col-10">
                      <input type="text" class="form-control answer" name="name[]" placeholder="Cat  Name" required />
                    </div>
                    <div class="col-2">
  ...
  <script>
    ...
    function page_editable_cat(id,name) { 
      $('#catid').val(id)
      $('#catname').val(name)
    }
